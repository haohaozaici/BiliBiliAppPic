 ...
 */
public class PermissionItemViewBinder extends ItemViewBinder<PermissionItem, PermissionItemViewBinder.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull PermissionItem permissionItem) {
